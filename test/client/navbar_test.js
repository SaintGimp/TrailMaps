...
define(["q", "jquery", "/test/lib/Squire.js", "/test/client/testableMapContainer.js"], function (
  Q,
  $,
  Squire,
  testableMapContainer
) {
  var navbarModel;
  var injector;
  var mapContainer;
  ...
  function initializeNavBar(done) {
    ...
    testableMapContainer.create("bing", server).done(function (newMapContainer) {
      server.respond();
  ...
  describe("Nav bar", function () {
    describe("Searching for mile markers", function () {
      ...
      it("should add the new map view to the browser history", function () {
        expect(historyStub.pushState.calledWith(mapContainer.getViewOptions(), null, mapContainer.getUrlFragment())).to
          .be.ok;
      });
    ...
    describe("Showing a map", function () {
      ...
      it("should replace the current browser history node with the new map name", function () {
        expect(historyStub.replaceState.calledWith(mapContainer.getViewOptions(), null, mapContainer.getUrlFragment()))
          .to.be.ok;
      });
